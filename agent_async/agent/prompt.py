...
- Output truncation: for the last 10 commands, only the last 200 lines of combined stdout/stderr are added back into your context; for earlier commands, only the last 5 lines are kept. Design commands to surface the most relevant lines (use tail/grep/rg or filters).
